...
The client-server model of web interactions refers to the request-response cycle of the HTTP protocol.
...
HTTP Requests consist of; http method, path, headers, and a message body.
HTTP Responses consist of; status code, headers, and message body.
